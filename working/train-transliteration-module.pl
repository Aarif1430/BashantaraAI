...
sub train_transliteration_module{
   ...
   print STDERR "Running Tuning for Transliteration Module\n";
    ...
    `/workspaces/BashantaraAI/mosesdecoder/scripts/training/mert-moses.pl /workspaces/BashantaraAI/tuning/tune.mr /workspaces/BashantaraAI/tuning/tune.en --decoder /workspaces/BashantaraAI/tuning/moses.filtered.ini /workspaces/BashantaraAI/mosesdecoder/bin/moses /workspaces/BashantaraAI/tuning/filtered/moses.ini  --nbest 100 --working-dir /workspaces/BashantaraAI/tuning --mertdir /workspaces/BashantaraAI/mosesdecoder/bin/ --working-dir /workspaces/BashantaraAI/tuning  -decoder-flags="-threads 4"`;
